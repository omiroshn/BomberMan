...
#define GAME_SIZE	20.0f
#define LIVE_TIME	2.0f
#define TEXTURE_COUNT 16
#define TIME_FOR_TEXTURE	0.75f// LIVE_TIME / TEXTURE_COUNT
#define MAX_SPHERE_RADIUS GAME_QUAD_SIZE / 3
...
void kernel update_cloud(global QuadParticle * particles, float deltaTime) {
	...
	texture_index %= 16;
	if (texture_index > 12 && texture_index <=15)
		texture_index -= 3;
	...
	particle_0->position.x += deltaTime;
	if (particle_0->position.x > GAME_SIZE)
		particle_0->position.x = -10;
