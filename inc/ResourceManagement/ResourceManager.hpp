...
public:
	...
	void                		loadModel(const GLchar *, std::string const &, glm::vec3 scale = glm::vec3(1.0f), glm::vec3 offset = glm::vec3(.0f), glm::vec3 rotate = glm::vec3(.0f, 1.0f, .0f), float angle = .0f, float glossiness = 0.1f);
