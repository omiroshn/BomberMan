...
void Renderer::init(int width, int height, std::string const& winName, std::string const& binFolder)
{
	...
	auto shader = mRessourceManager.loadShader(
			std::string(binFolder + "/Assets/shader/sprite.vx.glsl").c_str(),
			std::string(binFolder + "/Assets/shader/sprite.ft.glsl").c_str(),
			"sprite");
	...
	mRessourceManager.loadTexture(std::string(binFolder + "/Assets/img/block.png").c_str(), "block", false);
...
Renderer::Renderer(int width, int height, std::string const &winName, std::string const &binFolder)
{
	init(width, height, winName, binFolder);
};
